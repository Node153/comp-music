-- 커뮤니티 운영정책 개정(2026-08-29, 사용자가 공유한 법적 리스크 검토 반영 — 금지행위 확장,
-- 임시조치/제재기준 구체화, 저작권 신고 절차를 이용약관 제11조와 연결, 소명·이의신청,
-- 신고자 보호, 미성년자 보호 등 신설). community_guidelines 동의 버전을 올린다
-- (terms_of_service는 0041, privacy_policy는 0042에서 이미 올림).
--
...
begin
  ...
  if not is_oauth then
    ...
    values
      ...
      (new.id, 'community_guidelines', '2026-08-29'),
