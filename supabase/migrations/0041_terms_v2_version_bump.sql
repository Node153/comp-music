-- 이용약관 개정(2026-08-29, 사용자가 공유한 법적 리스크 검토 반영 — 운영자 정보, 게시물
-- 이용허락 범위 구체화, 가입심사/이용제한 사유 객관화, 권리침해 신고 절차·회원탈퇴 조항
-- 신설 등). 개인정보처리방침은 이번에 안 건드렸으므로 terms_of_service 버전만 올리고
-- privacy_policy는 그대로 둔다.
--
