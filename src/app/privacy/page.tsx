    ...
    <main className="mx-auto flex max-w-2xl flex-col gap-8 p-6 pb-20">
      ...
      <Section title="1. 수집하는 개인정보 항목">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            ...
            캡션, 태그), 댓글·Kick·1:1 메시지·memo 채팅 등 상호작용 기록, Companion(협업) 관계
            정보
          </li>
        </ul>
      ...
      <Section title="2. 개인정보의 수집 및 이용 목적">
        <ul className="list-disc pl-5">
          ...
          <li>알림 이메일(Kick·댓글·노크·Companion 신청·메시지 등) 발송</li>
      ...
      <Section title="3. 개인정보의 보유 및 이용기간">
        ...
        <Table
          ...
          rows={[
            ...
            [
              "DEMO(전체공개) 게시물·댓글·Kick",
              "작성자가 직접 삭제하거나 회원 탈퇴 시까지(노출기간이 끝나도 자동으로 삭제되지 않음)",
            ],
            [
              "memo(비공개) 게시물·댓글·Kick",
              "노출기간 종료 후 7일 뒤 첨부 미디어와 함께 자동 삭제. 그 전에 작성자가 직접 삭제하거나 회원 탈퇴 시에는 그 시점에 삭제",
            ],
            [
        ...
        />
        <p>
          DEMO(전체공개) 게시물은 메인 피드 노출 기간(회원이 정한 최대 노출시간)이 끝나도
          삭제되지 않고 본인 프로필 피드에는 계속 남는 서비스 특성이 있습니다(가입 시 안내).
          memo(비공개) 게시물은 이와 달리 노출 기간이 끝난 뒤 7일이 지나면 영상·이미지·음원
          파일과 함께 자동으로 삭제됩니다.
        </p>
      </Section>
