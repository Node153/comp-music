...
// 사이드바가 따라다녔다(인스타그램은 게시물 작성·DM·알림 화면에 피드 사이드바를 안 보여준다 —
// 그 화면 하나에만 집중하게). 비로그인 방문자는 원래도 사이드바가 없었으므로(GuestTopNav 분기)
// user가 없으면 children만 그대로 반환한다. getCurrentUser()는 (app)/layout.tsx·피드 페이지와
