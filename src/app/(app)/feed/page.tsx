...
export default async function FeedPage({
  ...
  // 데스크톱: DEMO는 미디어(4:3)가 높이를 정하는 자연 높이 카드(md:max-w-[620px]로 좁혀
                      ...
                      {post.isMock ? (
                        <div
                          className={`relative flex w-full items-center justify-center bg-gradient-to-br ${post.gradient} ${
                            oneScreenFeed ? "h-[40svh] md:h-auto md:aspect-[4/3]" : "h-[420px]"
                          }`}
                        >
                          {post.demoVideoSrc && (
                            <MockPlayOverlay
                        ...
                        <img
                          ...
                          className={`w-full object-cover ${
                            oneScreenFeed ? "h-[40svh] md:h-auto md:aspect-[4/3]" : "aspect-[4/5]"
                          }`}
                        />
