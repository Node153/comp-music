...
const selectClass =
  "h-8 rounded-lg border border-gray-200 bg-white px-2 text-xs text-gray-700 focus:border-gray-900 focus:outline-none";
    ...
    <div className="flex flex-wrap items-center gap-1.5">
      ...
      >
        <input
          ...
          placeholder="이름·닉네임·이메일·#태그 검색"
          className="h-8 w-full rounded-lg border border-gray-200 bg-white px-2.5 text-xs text-gray-900 placeholder:text-gray-400 focus:border-gray-900 focus:outline-none"
        />
      </form>
      <select
        aria-label="유형"
      ...
      >
        ...
        <option value="7">7일 이내 가입</option>
        <option value="30">30일 이내 가입</option>
      </select>
      <select
        aria-label="활동"
        className={selectClass}
      ...
      >
        ...
        <option value="7">7일 내 활동</option>
        <option value="30">30일 내 활동</option>
