...
// 각 제공자 공식 브랜드 컬러/마크를 인라인 SVG로 재현 — 외부 아이콘 CDN 의존 없이 자체 포함.
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 20 20" aria-hidden>
      <path
        fill="#4285F4"
        d="M19.6 10.23c0-.82-.07-1.42-.22-2.05H10v3.72h5.51c-.11.92-.72 2.3-2.07 3.22l-.02.13 3 2.32.21.02c1.91-1.76 3-4.35 3-7.36z"
      />
      <path
        fill="#34A853"
        d="M10 20c2.7 0 4.96-.89 6.62-2.41l-3.15-2.44c-.85.59-1.99 1-3.47 1-2.65 0-4.9-1.76-5.7-4.19l-.13.01-3.11 2.4-.04.12C2.72 17.78 6.05 20 10 20z"
      />
      <path
        fill="#FBBC05"
        d="M4.3 11.96c-.2-.59-.32-1.22-.32-1.96s.12-1.37.31-1.96l-.01-.13-3.14-2.44-.1.05C.31 6.9 0 8.41 0 10s.31 3.1.94 4.48l3.36-2.52z"
      />
      <path
        fill="#EA4335"
        d="M10 3.96c1.88 0 3.15.81 3.87 1.49l2.83-2.76C14.94.99 12.7 0 10 0 6.05 0 2.72 2.22.94 5.52l3.35 2.52C5.1 5.72 7.35 3.96 10 3.96z"
      />
    </svg>
  );
}
