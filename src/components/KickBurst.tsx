...
// Kick(0071)을 줬을 때 게시물 카드 중앙에 "Kick!" 문구가 크게 나타났다 사라지는 연출
// (사용자 요청, HeartBurst의 더블탭 하트 연출과 같은 패턴 — 예전엔 좋아요 버튼에 붙어 있었다).
// 트리거는 PostEngagementContext(kickKey)를 통해 KickButton과 공유하고, 이 컴포넌트는 게시물
